              ...
              <form id="quickForm" method="POST" action="../../include/member-code.php">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="roomName" id="roomName" class="form-control" placeholder="Room Name"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <!-- <label for="exampleInputPassword1">Password</label> -->
                    <input type="number" name="adults" id="adults" class="form-control" placeholder="Number of Adults"/>
                  </div>
                  <div class="form-group">
                    <!-- <label for="exampleInputPassword1">Password</label> -->
                    <input type="number" name="children" id="children" class="form-control" placeholder="Number of Children"/>
                  </div>
                  <div class="form-group">
                    <!-- <label for="exampleInputPassword1">Password</label> -->
                    <input type="number" name="roomPrice" id="roomPrice" class="form-control" placeholder="Room Price"/>
                  </div>
                  <div class="form-group">
                    <!-- <label for="exampleInputPassword1">Password</label> -->
                    <input type="number" name="roomQuantity" id="roomQuantity" class="form-control" placeholder="Room Quantity"/>
                  </div>
                  <div class="form-group">
                    <p>Add pictures of your rooms</p>
                  ...
                  <div class="form-group">
                    <select name="roomStatus" id="" class="form-control">
