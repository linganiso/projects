...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0">Add Facilities</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <br>
             <form action="../include/add-landlord.inc.php"  id="quickForm" method="post">
                <div class="form-group">
                                ...
                                <div class="form-group">
                                  <input type="text" name="facilityDescription" class="form-control" placeholder="Facility Description"/>
                                </div>
                                <div class="form-group">
                                  <input type="file" name="img"/>
                                </div>                               
                    <button type="submit" name="submit" class="btn btn-primary btn-block form-control" style="background: #343a40; margin-right: 5%; border: none;">Add Facilities</button>
              </form>
            </div>
            <!-- /.card -->
            </div>
