      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Print Results</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <br>
              ...
              <form action="../include/add-staff.inc.php"  id="quickForm" method="post">
                <div class="row">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary btn-block form-control" style="background: #343a40; border: none;">Search Leaner</button>
              </form>
            </div>
            <!-- /.card -->
            </div>
