        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="learner.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Linganiso</td>
                      <td>Male</td>
                      <td>linganisolethu98@gmail.com</td>
                      <td>063 570 0638</td>
                      <td>PO BOX 6122, MSOMBOVU, BUTTERWORTH, 4961</td>
                      <td>Princal</td>
                      <td>Grade 8 & 9</td>
